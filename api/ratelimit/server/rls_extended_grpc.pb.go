...
const (
	...
	RateLimitService_ChangeLimit_FullMethodName     = "/envoy.service.ratelimit.v3.RateLimitService/ChangeLimit"
)
...
type RateLimitServiceClient interface {
	...
	ChangeLimit(ctx context.Context, in *RateLimitRequest, opts ...grpc.CallOption) (*ChangeLimitResponse, error)
}
...
func (c *rateLimitServiceClient) ChangeLimit(ctx context.Context, in *RateLimitRequest, opts ...grpc.CallOption) (*ChangeLimitResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChangeLimitResponse)
	err := c.cc.Invoke(ctx, RateLimitService_ChangeLimit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RateLimitServiceServer interface {
	...
	ChangeLimit(context.Context, *RateLimitRequest) (*ChangeLimitResponse, error)
}
...
func (UnimplementedRateLimitServiceServer) ChangeLimit(context.Context, *RateLimitRequest) (*ChangeLimitResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangeLimit not implemented")
}
...
func _RateLimitService_ChangeLimit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RateLimitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RateLimitServiceServer).ChangeLimit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RateLimitService_ChangeLimit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RateLimitServiceServer).ChangeLimit(ctx, req.(*RateLimitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RateLimitService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ChangeLimit",
			Handler:    _RateLimitService_ChangeLimit_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rls_extended.proto",
}
