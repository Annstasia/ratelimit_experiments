...
func pipeAppend(
	pipeline redis.Pipeline, rcv interface{}, cmd, key string, args ...interface{},
) redis.Pipeline {
	...
	return func(t *testing.T) {
		...
		if usePerSecondRedis {
			cache = redis.NewFixedRateLimitCacheImpl(
				client, perSecondClient, timeSource, rand.New(rand.NewSource(1)), 0, nil, 0.8, "",
				sm, false,
			)
		} else {
			cache = redis.NewFixedRateLimitCacheImpl(
				client, nil, timeSource, rand.New(rand.NewSource(1)), 0, nil, 0.8, "", sm, false,
			)
		}
		...
		clientUsed.EXPECT().PipeAppend(
			gomock.Any(), gomock.Any(), "INCRBY", "domain_key_value_1234", uint64(1),
		).SetArg(1, uint64(5)).DoAndReturn(pipeAppend)
		clientUsed.EXPECT().PipeAppend(
			gomock.Any(), gomock.Any(), "EXPIRE", "domain_key_value_1234", int64(1),
		).DoAndReturn(pipeAppend)
		clientUsed.EXPECT().PipeDo(gomock.Any()).Return(nil)

		request := common.NewRateLimitRequest("domain", [][][2]string{{{"key", "value"}}}, 1)
		limits := []*config.RateLimit{
			config.NewRateLimit(
				10, pb.RateLimitResponse_RateLimit_SECOND, sm.NewStats("key_value"), false, false,
				"", nil, false,
			),
		}
			...
			[]*pb.RateLimitResponse_DescriptorStatus{
				{
					...
					DurationUntilReset: utils.CalculateReset(
		...
		timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
		clientUsed.EXPECT().PipeAppend(
			gomock.Any(), gomock.Any(), "INCRBY", "domain_key2_value2_subkey2_subvalue2_1200",
			uint64(1),
		).SetArg(1, uint64(11)).DoAndReturn(pipeAppend)
		clientUsed.EXPECT().PipeAppend(
		...
		limits = []*config.RateLimit{
			nil,
			config.NewRateLimit(
				10, pb.RateLimitResponse_RateLimit_MINUTE,
				sm.NewStats("key2_value2_subkey2_subvalue2"), false, false, "", nil, false,
			),
		}
		assert.Equal(
			[]*pb.RateLimitResponse_DescriptorStatus{
				...
				{
					Code: pb.RateLimitResponse_OVER_LIMIT, CurrentLimit: limits[1].Limit,
					LimitRemaining:     0,
					DurationUntilReset: utils.CalculateReset(&limits[1].Limit.Unit, timeSource),
				},
			},
			cache.DoLimit(context.Background(), request, limits),
		)
		...
		clientUsed.EXPECT().PipeAppend(
			gomock.Any(), gomock.Any(), "INCRBY", "domain_key3_value3_997200", uint64(0),
		).SetArg(1, uint64(11)).DoAndReturn(pipeAppend)
		clientUsed.EXPECT().PipeAppend(
			gomock.Any(), gomock.Any(),
		...
		clientUsed.EXPECT().PipeAppend(
			gomock.Any(), gomock.Any(), "INCRBY", "domain_key3_value3_subkey3_subvalue3_950400",
			uint64(1),
		).SetArg(1, uint64(13)).DoAndReturn(pipeAppend)
		clientUsed.EXPECT().PipeAppend(
			gomock.Any(), gomock.Any(),
		...
		limits = []*config.RateLimit{
			config.NewRateLimit(
				10, pb.RateLimitResponse_RateLimit_HOUR, sm.NewStats("key3_value3"), false, false,
				"", nil, false,
			),
			config.NewRateLimit(
				10, pb.RateLimitResponse_RateLimit_DAY,
				sm.NewStats("key3_value3_subkey3_subvalue3"), false, false, "", nil, false,
			),
		}
		assert.Equal(
			[]*pb.RateLimitResponse_DescriptorStatus{
				{
					Code: pb.RateLimitResponse_OVER_LIMIT, CurrentLimit: limits[0].Limit,
					LimitRemaining:     0,
					DurationUntilReset: utils.CalculateReset(&limits[0].Limit.Unit, timeSource),
				},
				{
					Code: pb.RateLimitResponse_OVER_LIMIT, CurrentLimit: limits[1].Limit,
					LimitRemaining:     0,
...
func testLocalCacheStats(
	localCacheStats gostats.StatGenerator, statsStore gostats.Store, sink *common.TestStatSink,
...
func TestOverLimitWithLocalCache(t *testing.T) {
	...
	sm := stats.NewMockStatManager(statsStore)
	cache := redis.NewFixedRateLimitCacheImpl(
		client, nil, timeSource, rand.New(rand.NewSource(1)), 0, localCache, 0.8, "", sm, false,
	)
	...
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key4_value4_997200", uint64(1),
	).SetArg(1, uint64(11)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(),
	...
	limits := []*config.RateLimit{
		config.NewRateLimit(
			15, pb.RateLimitResponse_RateLimit_HOUR, sm.NewStats("key4_value4"), false, false, "",
			nil, false,
		),
	}
	...
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key4_value4_997200", uint64(1),
	).SetArg(1, uint64(16)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(),
		"EXPIRE", "domain_key4_value4_997200", int64(3600),
	).DoAndReturn(pipeAppend)
...
func TestNearLimit(t *testing.T) {
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key5_value5_1234", uint64(3),
	).SetArg(1, uint64(5)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "EXPIRE", "domain_key5_value5_1234", int64(1),
	).DoAndReturn(pipeAppend)
	client.EXPECT().PipeDo(gomock.Any()).Return(nil)
	...
	limits = []*config.RateLimit{
		config.NewRateLimit(
			20, pb.RateLimitResponse_RateLimit_SECOND, sm.NewStats("key5_value5"), false, false, "",
			nil, false,
		),
	}
	...
	assert.Equal(
		[]*pb.RateLimitResponse_DescriptorStatus{
			{
				Code: pb.RateLimitResponse_OK, CurrentLimit: limits[0].Limit, LimitRemaining: 15,
				DurationUntilReset: utils.CalculateReset(
					&limits[0].Limit.Unit, timeSource,
				),
			},
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key6_value6_1234", uint64(2),
	).SetArg(1, uint64(7)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "EXPIRE", "domain_key6_value6_1234", int64(1),
	).DoAndReturn(pipeAppend)
	client.EXPECT().PipeDo(gomock.Any()).Return(nil)
	...
	limits = []*config.RateLimit{
		config.NewRateLimit(
			8, pb.RateLimitResponse_RateLimit_SECOND, sm.NewStats("key6_value6"), false, false, "",
			nil, false,
		),
	}
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key7_value7_1234", uint64(3),
	).SetArg(1, uint64(19)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "EXPIRE", "domain_key7_value7_1234", int64(1),
	).DoAndReturn(pipeAppend)
	client.EXPECT().PipeDo(gomock.Any()).Return(nil)
	...
	limits = []*config.RateLimit{
		config.NewRateLimit(
			20, pb.RateLimitResponse_RateLimit_SECOND, sm.NewStats("key7_value7"), false, false, "",
			nil, false,
		),
	}
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key8_value8_1234", uint64(3),
	).SetArg(1, uint64(22)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "EXPIRE", "domain_key8_value8_1234", int64(1),
	).DoAndReturn(pipeAppend)
	client.EXPECT().PipeDo(gomock.Any()).Return(nil)
	...
	limits = []*config.RateLimit{
		config.NewRateLimit(
			20, pb.RateLimitResponse_RateLimit_SECOND, sm.NewStats("key8_value8"), false, false, "",
			nil, false,
		),
	}
	...
	assert.Equal(
		[]*pb.RateLimitResponse_DescriptorStatus{
			{
				Code: pb.RateLimitResponse_OVER_LIMIT, CurrentLimit: limits[0].Limit,
				LimitRemaining: 0, DurationUntilReset: utils.CalculateReset(
					&limits[0].Limit.Unit, timeSource,
				),
			},
		},
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key9_value9_1234", uint64(7),
	).SetArg(1, uint64(22)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "EXPIRE", "domain_key9_value9_1234", int64(1),
	).DoAndReturn(pipeAppend)
	client.EXPECT().PipeDo(gomock.Any()).Return(nil)
	...
	limits = []*config.RateLimit{
		config.NewRateLimit(
			20, pb.RateLimitResponse_RateLimit_SECOND, sm.NewStats("key9_value9"), false, false, "",
			nil, false,
		),
	}
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key10_value10_1234", uint64(3),
	).SetArg(1, uint64(30)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "EXPIRE", "domain_key10_value10_1234", int64(1),
	).DoAndReturn(pipeAppend)
	client.EXPECT().PipeDo(gomock.Any()).Return(nil)
	...
	limits = []*config.RateLimit{
		config.NewRateLimit(
			10, pb.RateLimitResponse_RateLimit_SECOND, sm.NewStats("key10_value10"), false, false,
			"", nil, false,
		),
	}
...
func TestRedisWithJitter(t *testing.T) {
	...
	sm := stats.NewMockStatManager(statsStore)
	cache := redis.NewFixedRateLimitCacheImpl(
		client, nil, timeSource, rand.New(jitterSource), 3600, nil, 0.8, "", sm, false,
	)
	...
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "EXPIRE", "domain_key_value_1234", int64(101),
	).DoAndReturn(pipeAppend)
	client.EXPECT().PipeDo(gomock.Any()).Return(nil)
...
func TestOverLimitWithLocalCacheShadowRule(t *testing.T) {
	...
	limits := []*config.RateLimit{
		config.NewRateLimit(
			15, pb.RateLimitResponse_RateLimit_HOUR, sm.NewStats("key4_value4"), false, true, "",
			nil, false,
		),
	}
...
func TestOverLimitWithStopCacheKeyIncrementWhenOverlimitConfig(t *testing.T) {
	...
	sm := stats.NewMockStatManager(statsStore)
	cache := redis.NewFixedRateLimitCacheImpl(
		client, nil, timeSource, rand.New(rand.NewSource(1)), 0, localCache, 0.8, "", sm, true,
	)
	sink := &common.TestStatSink{}
	localCacheStats := limiter.NewLocalCacheStats(localCache, statsStore.Scope("localcache"))
	...
	timeSource.EXPECT().UnixNow().Return(int64(1000000)).MaxTimes(5)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "GET", "domain_key4_value4_997200",
	).SetArg(1, uint64(10)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "GET", "domain_key5_value5_997200",
	).SetArg(1, uint64(10)).DoAndReturn(pipeAppend)
	...
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key5_value5_997200", uint64(1),
	).SetArg(1, uint64(11)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(),
		"EXPIRE", "domain_key5_value5_997200", int64(3600),
	).DoAndReturn(pipeAppend)
	client.EXPECT().PipeDo(gomock.Any()).Return(nil).Times(2)

	request := common.NewRateLimitRequestWithPerDescriptorHitsAddend(
		"domain", [][][2]string{{{"key4", "value4"}}, {{"key5", "value5"}}}, []uint64{1, 1},
	)
	...
	limits := []*config.RateLimit{
		...
		config.NewRateLimit(
			14, pb.RateLimitResponse_RateLimit_HOUR, sm.NewStats("key5_value5"), false, false, "",
			nil, false,
		),
	}
	...
	assert.Equal(
		[]*pb.RateLimitResponse_DescriptorStatus{
			...
			{
				Code: pb.RateLimitResponse_OK, CurrentLimit: limits[1].Limit, LimitRemaining: 3,
				DurationUntilReset: utils.CalculateReset(&limits[1].Limit.Unit, timeSource),
			},
		},
		cache.DoLimit(context.Background(), request, limits),
	...
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key4_value4_997200", uint64(2),
	).SetArg(1, uint64(13)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(),
		"EXPIRE", "domain_key4_value4_997200", int64(3600),
	...
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key5_value5_997200", uint64(2),
	).SetArg(1, uint64(13)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(),
		"EXPIRE", "domain_key5_value5_997200", int64(3600),
	...
	request = common.NewRateLimitRequestWithPerDescriptorHitsAddend(
		"domain", [][][2]string{{{"key4", "value4"}}, {{"key5", "value5"}}}, []uint64{2, 2},
	)
	...
	assert.Equal(
		[]*pb.RateLimitResponse_DescriptorStatus{
			...
			{
				Code: pb.RateLimitResponse_OK, CurrentLimit: limits[1].Limit, LimitRemaining: 1,
				DurationUntilReset: utils.CalculateReset(&limits[1].Limit.Unit, timeSource),
			},
		},
		cache.DoLimit(context.Background(), request, limits),
	...
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key4_value4_997200", uint64(0),
	).SetArg(1, uint64(13)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(),
		"EXPIRE", "domain_key4_value4_997200", int64(3600),
	...
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(), "INCRBY", "domain_key5_value5_997200", uint64(2),
	).SetArg(1, uint64(15)).DoAndReturn(pipeAppend)
	client.EXPECT().PipeAppend(
		gomock.Any(), gomock.Any(),
		"EXPIRE", "domain_key5_value5_997200", int64(3600),
	).DoAndReturn(pipeAppend)
